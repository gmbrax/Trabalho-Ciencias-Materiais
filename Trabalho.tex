...
\\
Ele observou uma nova linha violeta no espectro atômico de zinco extraído de uma amostra de blenda de zinco \ch{ZnS} dos Pirineus, o que indicava a presença de um elemento desconhecido.
\\
...
O Gálio é encontrado em minérios de alumínio e zinco, como a bauxita e a blenda de zinco \ch{ZnS}, geralmente como um subproduto da mineração desses elementos, no Brasil, ele pode ser extraído em depósitos de bauxita, como em Minas Gerais, que é um grande produtor de alumínio.
...
\begin{itemize}
    \item \textbf{Distribuição Uniforme:} Quando o fluido dentro da câmara de vapor se aquece, ele evapora e transporta o calor para outras áreas da câmara. 
    Isso permite que o calor seja distribuído e dissipado de forma mais eficaz, evitando pontos quentes localizados que poderiam danificar componentes internos.
...
\begin{table}[H]
    ...
    \begin{tabular}{@{}l|l|l|l@{}}
     &
      \multicolumn{1}{c|}{Metal Liquido} &
      \multicolumn{1}{c|}{Pasta Térmica} &
      \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Delta\\ $1-(\frac{Metal Liquido}{Pasta Termica})$\end{tabular}} \\ \midrule
    Decibel (dB) &
      27.8 &
      36 &
      22,77\% \\ \midrule
